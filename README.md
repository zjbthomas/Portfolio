...
- **Frequency-based AI-generated Images Detection**  
    ...
    - A Model Context Protocol (**MCP**) *Server* is implemented [here](https://github.com/zjbthomas/FreqAIDetector/tree/main/deploy/MCP) as a *Tool* written in **TypeScript**, enabling LLMs to invoke the model for inference.
